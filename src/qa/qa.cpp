...
*/
   		...
   		else if (choice == 6)
        {
			...
			if (true)
			{
				//WBAES::gen_aes("aes512", "./", true);
				//WBAES::wbaes_mgr mgr("aes512", "./", "name1", true);

				WBAES::gen_aes("aes1024", "./", "name2", true);
				WBAES::wbaes_mgr mgr("aes1024", "./", "name2", true);

				unsigned char plain[] = { 	0x51, 0x61, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xf,
											...
											0x70, 0x31, 0x32, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
											0x51, 0x61, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xf,
											0x70, 0x31, 0x32, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
											0x51, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xf,
											0x70, 0x31, 0x32, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,}; //plaintext example
				unsigned char plaincopy[] = { 	0x51, 0x61, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xf,
											0x70, 0x31, 0x32, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
											0x51, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xf,
											0x70, 0x31, 0x32, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,
											0x51, 0x61, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xf,
											...
											0x51, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xf,
											0x70, 0x31, 0x32, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff,}; //plaintext example
				unsigned char eout[128] = {0};
				unsigned char dout[128] = {0};
				...
				unsigned int plainLen = 128 * sizeof(unsigned char);  //bytes in plaintext
				...
				//mgr.a512.aes_whitebox_encrypt_cfb(iv, plaincopy, plainLen, eout);
				mgr.a1024.aes_whitebox_encrypt_cfb(iv, plaincopy, plainLen, eout);
				std::cout << "AES  encrypt: ";
				for(size_t i=0;i<plainLen;i++) std::cout << (int)eout[i];
				std::cout <<std::endl;

				//mgr.a512.aes_whitebox_decrypt_cfb(iv, eout, plainLen, dout);
				mgr.a1024.aes_whitebox_decrypt_cfb(iv, eout, plainLen, dout);
				...
				std::cout << "OK with binary AES  cfb algo "<<std::endl;
