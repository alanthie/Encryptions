...
Optional arguments:
  ...
  -wbaespv, --wbaespv     	specify the private folder for whitbox aes 512-8192 bits tables [default: ""]
  -wbaespu, --wbaespu     	specify the other public folder for whitbox aes 512-8192 bits tables [default: ""]
